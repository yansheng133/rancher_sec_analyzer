...
Create an `aliases.json` in the root directory to handle hardcoded naming exceptions. The script processes these mappings after stripping system prefixes.
...
The tool generates the following reports upon completion:
